...
[项目首页](../README.md) · [简体中文入口](README_zh-cn.md) · [日本語](README_ja-jp.md) · [当前 Release](https://github.com/GoldenEggOVO/ExtendedNoteBlock/releases/tag/v2.13.0-mc26.2)

这里集中维护 Extended Note Block 的用户说明、Paper / Purpur 技术文档和版本记录。当前基线为 Minecraft **26.2**、Full Fabric / Paper Client **2.13.0**、Paper Server **0.14.0**。
...
- [2.13.0 发布说明](releases/2.13.0.md)：当前版本的安装变化、资源包和音频优化。
