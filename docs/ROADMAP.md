...
[返回首页](../README.md) · [2.11.0 更新说明](releases/2.11.0.md)

当前基线为 Full Fabric / Paper Client **2.11.0** 与 Paper Server **0.11.0**。
...
用户已确认 Paper Client 的 GUI、音高与资源加载正常，2.10.1 自动资源包也能加载物品材质并正常聆听；已知剩余音频瑕疵需要后续按音色试听调整。2.11.0 新增无实体的已放置 ENB 简化外观，仍需实际 Purpur 多人和大结构复测。
