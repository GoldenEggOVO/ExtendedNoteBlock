...
現在のリリースは **Full Fabric / Paper Client 2.13.1**、**Paper Server 0.14.1** です。Minecraft **26.2** と Java **25** を対象としています。

[2.13.1 をダウンロード](https://github.com/GoldenEggOVO/ExtendedNoteBlock/releases/tag/v2.13.1-mc26.2) · [機能紹介](FEATURES.md) · [インストールガイド（中文）](INSTALLATION.md)
...
- [2.13.1 リリースノート（中文）](releases/2.13.1.md)
